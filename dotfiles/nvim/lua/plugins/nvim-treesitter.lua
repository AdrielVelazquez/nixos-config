return {
  ...
  },
  {
    ...
    config = function()
      -- Configure nvim-treesitter with textobjects settings
      -- Required because textobjects functions call configs.get_module() internally
      ...
      vim.keymap.set({ 'n', 'x', 'o' }, ']d', function()
        ts_move.goto_next '@conditional.outer'
      ...
      vim.keymap.set({ 'n', 'x', 'o' }, '[d', function()
        ts_move.goto_previous '@conditional.outer'
